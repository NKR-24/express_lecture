...
// Define a GET route. endpoint is "/hello"
APP.get("/hello", (req, res) => {
  const ipaddr = req.ip;
  console.log(`requested from ${ipaddr}`);
  res.status(200).send("hello"); //make a simple text response with status code 200(success)
});
